    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      <div className="container grid h-16 md:h-20 grid-cols-[auto,1fr,auto] items-center gap-2 md:gap-4">
        ...
        <Link to="/" className="justify-self-center text-center group min-w-0">
          <span className="font-brand text-lg sm:text-2xl md:text-3xl lg:text-4xl font-normal tracking-[0.06em] sm:tracking-[0.08em] md:tracking-[0.1em] lg:tracking-[0.12em] uppercase transition-opacity group-hover:opacity-80 whitespace-nowrap">
            Wael Ben Yaghlane
          </span>
